...
/**
 * @ApiResource()
 * @ORM\Entity(repositoryClass=AnnounceTypeRepository::class)
 */
class AnnounceType
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Announce::class, mappedBy="announceType")
     */
    private $announces;
    ...
    public function removeAnnounce(Announce $announce): self
    {
        if ($this->announces->removeElement($announce)) {
            ...
            if ($announce->getAnnounceType() === $this) {
                $announce->setAnnounceType(null);
            }
        }
