...
class AccomodationType
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Announce::class, mappedBy="accomodationType")
     */
    private $announces;
    ...
    public function addAnnounce(Announce $announce): self
    {
        if (!$this->announces->contains($announce)) {
            ...
            $announce->setAccomodationType($this);
        }
    ...
    public function removeAnnounce(Announce $announce): self
    {
        if ($this->announces->removeElement($announce)) {
            ...
            if ($announce->getAccomodationType() === $this) {
                $announce->setAccomodationType(null);
            }
        }
